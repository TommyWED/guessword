...
function showAns(){
  ...
  document.getElementById("showans").innerHTML = "Hide Answer"
  document.getElementById("showans").onclick = hideAns;
}

function hideAns(){
  document.getElementById("word1").style.display = "none";
  document.getElementById("showans").innerHTML = "Show Answer"
  document.getElementById("showans").onclick = showAns;
...
if (word == document.getElementById('name').innerHTML){
  ...
  document.getElementById('correctWord').innerHTML = word
        ...
        var guesslist ='';
          ...
          document.getElementById('correctWord').innerHTML += `<p>${attempts}.${guesslist}<p>`;
        } 
  } else if (attempts == 5){
...
const attempt =() =>{
  ...
  attemptN ++;
  var guessans = ""
  var atans = document.getElementById("name").innerHTML
  if (attemptN < 5){
    if (word == atans){
      console.log("Win")
      ...
      newli.innerHTML = guessans
      document.getElementById("resultR").appendChild(newli)
      document.getElementById("name").innerHTML = ""
      
    } 
    
  }else if(attemptN == 5 && word == atans ){
    console.log("Win")
    document.getElementById("big").style.display = "none"
    document.getElementById("win").style.display = "block"
  }else{
